...
from src.models.model_integration import ModelIntegrator
...
class TestIntegrationWithUI(unittest.TestCase):
    ...
    def test_model_integrator_consistency(self):
        ...
        transformed_data = self.model_integrator.transform_applicant_data(
            self.sample_applicant
        )
    ...
    def test_session_state_consistency(self):
        ...
        # Should be identical
        self.assertEqual(
            scores1, scores2, "Scores should be consistent across calculations"
        )
...
def run_unified_scoring_tests():
    ...
    # Add test classes
    test_classes = [TestUnifiedTrustScoring, TestIntegrationWithUI, TestPerformance]
    ...
    return {
        ...
        "details": {"failures": result.failures, "errors": result.errors},
    }
